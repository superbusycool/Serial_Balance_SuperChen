...
for i=leg
    ...
    % [k,q,r]=get_k_length_theta_offset_fast(i);
    k11(j) = k(1,1);
    k12(j) = k(1,2);
    k13(j) = k(1,3);
    k14(j) = k(1,4);
...
fprintf('self.a11[:] = [%.4f, %.4f, %.4f, %.4f]\n', a11(1), a11(2), a11(3), a11(4));
fprintf('self.a12[:] = [%.4f, %.4f, %.4f, %.4f]\n', a12(1), a12(2), a12(3), a12(4));
fprintf('self.a13[:] = [%.4f, %.4f, %.4f, %.4f]\n', a13(1), a13(2), a13(3), a13(4));
fprintf('self.a14[:] = [%.4f, %.4f, %.4f, %.4f]\n', a14(1), a14(2), a14(3), a14(4));
fprintf('self.a15[:] = [%.4f, %.4f, %.4f, %.4f]\n', a15(1), a15(2), a15(3), a15(4));
fprintf('self.a16[:] = [%.4f, %.4f, %.4f, %.4f]\n', a16(1), a16(2), a16(3), a16(4));

fprintf('self.a21[:] = [%.4f, %.4f, %.4f, %.4f]\n', a21(1), a21(2), a21(3), a21(4));
fprintf('self.a22[:] = [%.4f, %.4f, %.4f, %.4f]\n', a22(1), a22(2), a22(3), a22(4));
fprintf('self.a23[:] = [%.4f, %.4f, %.4f, %.4f]\n', a23(1), a23(2), a23(3), a23(4));
fprintf('self.a24[:] = [%.4f, %.4f, %.4f, %.4f]\n', a24(1), a24(2), a24(3), a24(4));
fprintf('self.a25[:] = [%.4f, %.4f, %.4f, %.4f]\n', a25(1), a25(2), a25(3), a25(4));
fprintf('self.a26[:] = [%.4f, %.4f, %.4f, %.4f]\n', a26(1), a26(2), a26(3), a26(4));
