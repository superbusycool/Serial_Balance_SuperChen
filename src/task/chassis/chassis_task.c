...
/*记录下Q和R
    % Q=diag([15 30 1 1 350 5]);
    % R=diag([2.75 1.5]);
K矩阵 =
  [-12.061447,  -3.579060,  -0.594148,  -1.399059,   4.309827,   0.669004;
     5.557982,   1.551555,   0.152635,   0.386741,  18.977525,   2.461554]
 */
            a11[0] = 23.8179f, a11[1] = -19.3163f, a11[2] = 0.1346f, a11[3] = -11.9056f;
            a12[0] = 4.5713f,  a12[1] = -4.5667f,  a12[2] = 0.1545f,   a12[3] = -3.5534f;
            a13[0] = 0.1093f, a13[1] = -0.0739f,   a13[2] = -0.0030f,  a13[3] = -0.5932f;
            a14[0] = -0.2616f, a14[1] = 0.1487f,   a14[2] = 0.0164f,   a14[3] = -1.4019f;
            a15[0] = 26.8530f, a15[1] = -20.8822f, a15[2] = 0.1433f,  a15[3] = 4.4775f;
            a16[0] = 3.5397f,  a16[1] = -2.7494f,  a16[2] = 0.0168f,   a16[3] = 0.6913f;
            a21[0] = 10.4188f, a21[1] = -9.0329f,  a21[2] = 0.5544f,   a21[3] = 5.5825f;
            a22[0] = 9.0860f,  a22[1] = -7.1064f,  a22[2] = 0.0756f,   a22[3] = 1.6060f;
            a23[0] = 1.0448f,  a23[1] = -0.8387f,  a23[2] = 0.0228f,   a23[3] = 0.1577f;
            a24[0] = 2.7610f,  a24[1] = -2.1434f,  a24[2] = 0.0221f,   a24[3] = 0.4032f;
            a25[0] = -12.0060f, a25[1] = 8.1418f,   a25[2] = 0.4706f,  a25[3] = 18.8611f;
            a26[0] = -1.7684f, a26[1] = 1.2237f,   a26[2] = 0.0582f,   a26[3] = 2.4453f;
...
*/
            ...
            a11[0] = 24.9617f, a11[1] = -20.0250f, a11[2] = 0.0845f, a11[3] = -12.9427f;
            a12[0] = 5.0679f,  a12[1] = -4.8726f,  a12[2] = 0.1285f,   a12[3] = -4.4726f;
            a13[0] = 0.1261f, a13[1] = -0.0848f,   a13[2] = -0.0039f,  a13[3] = -0.5914f;
            a14[0] = -0.2935f, a14[1] = 0.1847f,   a14[2] = 0.0132f,   a14[3] = -1.4640f;
            a15[0] = 33.3435f, a15[1] = -25.9189f, a15[2] = 0.1794f,  a15[3] = 5.5285f;
            a16[0] = 4.5320f,  a16[1] = -3.5195f,  a16[2] = 0.0225f,   a16[3] = 0.8540f;
            a21[0] = 13.3545f, a21[1] = -11.4234f,  a21[2] = 0.6248f,   a21[3] = 6.0159f;
            a22[0] = 11.7852f,  a22[1] = -9.2040f,  a22[2] = 0.0920f,   a22[3] = 2.0472f;
            a23[0] = 1.1137f,  a23[1] = -0.8883f,  a23[2] = 0.0209f,   a23[3] = 0.1715f;
            a24[0] = 3.0896f,  a24[1] = -2.3823f,  a24[2] = 0.0153f,   a24[3] = 0.4586f;
            a25[0] = -14.5507f, a25[1] = 9.7773f,   a25[2] = 0.6100f,  a25[3] = 23.7145f;
            a26[0] = -2.1654f, a26[1] = 1.4780f,   a26[2] = 0.0803f,   a26[3] = 3.1886f;
 ...
 * @brief 倒地自起
 * */
#define PHI0_DIRECTION1 (0.0F + 16.0f * DEGREE_2_RAD)
#define PHI0_DIRECTION2 (PI - 20.0f * DEGREE_2_RAD)
