...
static pid_config_t imu_temp_config = INIT_PID_CONFIG(160,40,0.0001, 100, 500, PID_Integral_Limit);
#else
...
void ins_task_init(){
    ...
    BMI088_Read(&BMI088);
    ins_init();
    gimbal_imu = dm_imu_init(DM_IMU_TX_ID,DM_IMU_RX_ID,&hfdcan2);/*位于云台的dm_imu*/
