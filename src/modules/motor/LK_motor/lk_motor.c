...
extern FDCAN_HandleTypeDef fdcan2;
...
//                 set = (int16_t)(LQROutBuf[LEFT][0] * LK_TOR_TO_CUR) + yaw_pid->Output;
//             }else{
//                 set = 0.0f;
//             }
//
...
//         if(chassis_cmd.ctrl_mode == CHASSIS_OPEN_LOOP){ //平衡时,才启动转向
//             if(Wheel_Shut_Flag == 0){
//                 set = -(int16_t)(LQROutBuf[RIGHT][0] * LK_TOR_TO_CUR) + yaw_pid->Output;
//             }else{
//                 set = 0.0f;
//             }
//
...
//             .rx_id = 0x141,
//     };
//     lk_motor[LEFT] = lk_motor_register(&motor_config1, lk_control[LEFT]);
//
...
//             .rx_id = 0x142,
//     };
//     lk_motor[RIGHT] = lk_motor_register(&motor_config_2, lk_control[RIGHT]);
// }