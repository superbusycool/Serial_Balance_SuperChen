...
disp(q);
disp(r);
fprintf('float a11[4] = {%.4f,%.4f,%.4f,%.4f};\n',a11(1),a11(2),a11(3),a11(4));
fprintf('float a12[4] = {%.4f,%.4f,%.4f,%.4f};\n',a12(1),a12(2),a12(3),a12(4));
fprintf('float a13[4] = {%.4f,%.4f,%.4f,%.4f};\n',a13(1),a13(2),a13(3),a13(4));
fprintf('float a14[4] = {%.4f,%.4f,%.4f,%.4f};\n',a14(1),a14(2),a14(3),a14(4));
fprintf('float a15[4] = {%.4f,%.4f,%.4f,%.4f};\n',a15(1),a15(2),a15(3),a15(4));
fprintf('float a16[4] = {%.4f,%.4f,%.4f,%.4f};\n',a16(1),a16(2),a16(3),a16(4));

fprintf('float a21[4] = {%.4f,%.4f,%.4f,%.4f};\n',a21(1),a21(2),a21(3),a21(4));
fprintf('float a22[4] = {%.4f,%.4f,%.4f,%.4f};\n',a22(1),a22(2),a22(3),a22(4));
fprintf('float a23[4] = {%.4f,%.4f,%.4f,%.4f};\n',a23(1),a23(2),a23(3),a23(4));
fprintf('float a24[4] = {%.4f,%.4f,%.4f,%.4f};\n',a24(1),a24(2),a24(3),a24(4));
fprintf('float a25[4] = {%.4f,%.4f,%.4f,%.4f};\n',a25(1),a25(2),a25(3),a25(4));
fprintf('float a26[4] = {%.4f,%.4f,%.4f,%.4f};\n',a26(1),a26(2),a26(3),a26(4));
toc
